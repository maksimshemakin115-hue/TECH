...
<div class="container">
    <h1 class="page-title">О компании TechPeriph</h1>
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card shadow">
                <div class="card-body">
                    <p>Компания <strong>TechPeriph</strong> основана в 2020 году и специализируется на продаже качественной компьютерной техники и периферии.</p>
                    <p>Мы предлагаем:</p>
                    <ul>
                        <li>Игровые ПК любой конфигурации</li>
                        <li>Механические и мембранные клавиатуры</li>
                        <li>Игровые мыши от ведущих брендов</li>
                        <li>Мониторы с частотой обновления до 360 Гц</li>
                        <li>Гарнитуры и аксессуары для киберспорта</li>
                    </ul>
                    <p>Наши преимущества:</p>
                    <ul>
                        <li>Быстрая доставка по всей России (1-3 дня)</li>
                        <li>Гарантия 2 года на все товары</li>
                        <li>Рассрочка 0% на 6 месяцев</li>
                        <li>Квалифицированная поддержка</li>
                    </ul>
                    <p class="mt-4 text-center"><strong>TechPeriph — ваш надёжный партнёр в мире технологий!</strong></p>
                </div>
            </div>
        </div>
    </div>
